...
function randomizeJSONData(data) {
    ...
    // Full credit for the randomization code below goes to the authors - Ronald Fisher and Frank Yates. More info in readme.
...
function endGame() {
    ...
    <h2 class="mt-3">You selected the category: ${selectedCategory}, and your difficulty was: ${difficulty}.</h2>
